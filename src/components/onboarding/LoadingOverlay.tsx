...
const tasks = [
  'Analyzing industry fuel sensitivity...',
  'Calculating country pass-through rates...',
  'Building your impact model...',
  'Generating personalized forecasts...'
];
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-5 flex flex-col items-center">
          <img 
			...
			/>
          <h3 className="text-2xl font-extrabold tracking-tight font-[var(--font-sora)]">Setting up your dashboard.</h3>
          {/* <p className="text-xs text-[var(--ink3)]">Please wait while your isolated analytical cluster environment builds.</p> */}
        </div>
        ...
        <div className="space-y-3.5 ">
          {tasks.map((t, idx) => {
            ...
            return (
              <div key={idx} className={`flex items-center gap-3 transition-opacity duration-300 ${isDone || isActive ? 'opacity-100' : 'opacity-25'}`}>
        ...
        <div className="w-full h-1 bg-[var(--bd)] rounded-full overflow-hidden relative">
          <div className="h-full bg-gradient-to-r from-[var(--pur)] to-[var(--cyan)] animate-[loadingBar_4.8s_linear_infinite]" style={{ width: '100%' }} />
        </div>
      </div>
      <style jsx>{`
